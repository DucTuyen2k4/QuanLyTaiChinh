    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    <img width="320px" height="320px" src="${sessionScope['user'].getImage()}" alt="picture">
                    <div class="small font-italic text-muted mb-4">JPG only</div>
                </div>

            </div>
            <form method="post" action="/Home?action=uploadPicture" enctype="multipart/form-data">
        ...
        <div class="col-xl-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/Home?action=UpdateProfile" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control formatted-number" id="phoneNumber" name="phoneNumber" type="text" placeholder="Enter your phone number" value="${sessionScope['user'].getPhoneNumber()}">
                        </div>
