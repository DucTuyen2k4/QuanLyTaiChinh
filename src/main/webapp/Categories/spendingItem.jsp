...
<style>
    ...
    .square-100x100 {
        ...
        width: 700px;
        height: 600px;
        background-color: #c4bcbc; /* Màu nền của hình vuông */
    ...
    .top-nav2 {
        ...
        width: 600px;
        height: 400px;
        background-color: #ec2525; /* Màu nền của hình vuông */
...
<main>
    ...
    <div class="middle-pane">
        <div class="square-100x100">
            <div CLASS="top-nav1" style="margin-left: 100px">
                <button style="margin-left: 30px; margin-top: 20px;"><a href="">Ăn Uống</a></button>
                <button style="margin-left: 30px; margin-top: 20px;"><a href="">Xăng xe</a></button>
                <button style="margin-left: 30px; margin-top: 20px;"><a href="">Tiền Phòng</a></button>
                <button style="margin-left: 30px; margin-top: 20px;"><a href="">Tiết Kiệm</a></button>
            </div>
<div class="top-nav2">
