...
<style>
    ...
    .square-100x100 {
        ...
        width: 700px;
        height: 400px;
        background-color: #eaeeea; /* Màu nền của hình vuông */
                ...
                <li><a href="#">Categories</a>
                    <ul class="dropdown-menu dropdown-menu-dark">
                        <c:forEach var="listCategory" items="${listCategory}">
                            <li>
                                <span>${listCategory.nameCategory}</span>
                            </li>
                        </c:forEach>
...
<main>
    ...
    <div class="middle-pane">
        <div class="square-100x100">
            <h5  for="userName">Tên Danh Mục : </h5>
            <input type="text" class="no-border " name="userName" id="userName" value="${listCategory.nameCategory}" required><br>
            <h5 for="password">Ghi Chú</h5>
            <input class="no-border " type="password" id="password" name="password" value="" ><br><br>
            <button><a href="">Cập nhât</a></button>
